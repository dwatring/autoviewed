(function () {
  ...
  */
  ...
  function O$1(a, b, c, e, d) {
    ...
    else if (((f = y$2(a)), 'function' === typeof f))
  ...
  var _extends2 = _interopRequireDefault$5(_extends.exports);

  var _typeof2$1 = _interopRequireDefault$5(_typeof$2.exports);
  ...
  var _chainPropTypes$1 = _interopRequireDefault$4(chainPropTypes$1);
  ...
  var _default$3 = elementAcceptingRef;
  elementAcceptingRef$1.default = _default$3;
  ...
  var _chainPropTypes = _interopRequireDefault$3(chainPropTypes$1);
  ...
  var _default$2 = (0, _chainPropTypes.default)(
    PropTypes.elementType,
    elementTypeAcceptingRef,
  );

  elementTypeAcceptingRef$1.default = _default$2;
  ...
  _interopRequireDefault$2(defineProperty$1.exports);

  _interopRequireDefault$2(_extends.exports);
  ...
  var _typeof2 = _interopRequireDefault$1(_typeof$2.exports);
  ...
  ponyfillGlobal.default = _default$1;
    ...
    return {
      create: function create(theme, name) {
        ...
        Object.keys(overrides).forEach(function (key) {
          stylesWithOverrides[key] = utils.deepmerge(
  ...
  function styled$2(Component) {
    var componentCreator = function componentCreator(style) {
      ...
      var StyledComponent = /*#__PURE__*/ React.forwardRef(
  ...
  var withStyles$1 = function withStyles(stylesOrCreator) {
    ...
    return function (Component) {
      ...
      var WithStyles = /*#__PURE__*/ React.forwardRef(function WithStyles(
        props,
        ref,
      ) {
        props.classes;
  ...
  function withThemeCreator() {
    ...
    var withTheme = function withTheme(Component) {
      var WithTheme = /*#__PURE__*/ React.forwardRef(function WithTheme(
        props,
        ref,
      ) {
        var innerRef = props.innerRef,
  ...
  function decomposeColor(color) {
    ...
    if (['rgb', 'rgba', 'hsl', 'hsla'].indexOf(type) === -1) {
      throw new Error(utils.formatMuiErrorMessage(3, color));
    }
  ...
  function createPalette(palette) {
    ...
    var augmentColor = function augmentColor(color) {
      ...
      if (!color.main) {
        throw new Error(utils.formatMuiErrorMessage(4, mainShade));
      }
    ...
    var paletteOutput = utils.deepmerge(
      _extends$1(
        {
  ...
  function capitalize(string) {
    if (typeof string !== 'string') {
      throw new Error(utils.formatMuiErrorMessage(7));
    }
  ...
  var SvgIcon$1 = withStyles(styles$6, {
    name: 'MuiSvgIcon',
  })(SvgIcon);
  ...
  var SuccessOutlinedIcon = createSvgIcon(
  ...
  var ReportProblemOutlinedIcon = createSvgIcon(
    /*#__PURE__*/ react.exports.createElement('path', {
  ...
  var ErrorOutlineIcon = createSvgIcon(
    /*#__PURE__*/ react.exports.createElement('path', {
  ...
  var InfoOutlinedIcon = createSvgIcon(
    /*#__PURE__*/ react.exports.createElement('path', {
  ...
  var defaultIconMapping = {
    success: /*#__PURE__*/ react.exports.createElement(SuccessOutlinedIcon, {
      fontSize: 'inherit',
    }),
    warning: /*#__PURE__*/ react.exports.createElement(
      ReportProblemOutlinedIcon,
      {
        fontSize: 'inherit',
      },
    ),
    error: /*#__PURE__*/ react.exports.createElement(ErrorOutlineIcon, {
      fontSize: 'inherit',
    }),
    info: /*#__PURE__*/ react.exports.createElement(InfoOutlinedIcon, {
      fontSize: 'inherit',
    }),
  };

  var _ref = /*#__PURE__*/ react.exports.createElement(CloseIcon, {
    fontSize: 'small',
  });

  var Alert = /*#__PURE__*/ react.exports.forwardRef(function Alert(
    props,
    ref,
  ) {
    var action = props.action,
      ...
      iconMapping =
        _props$iconMapping === void 0 ? defaultIconMapping : _props$iconMapping,
  ...
  const PopupMessage = ({ isConfigured, optionsUrl }) =>
    React.createElement(
      'div',
      { style: { minWidth: 300 } },
      isConfigured
        ? React.createElement(
            Alert$1,
            { severity: 'info' },
            'Thanks for using this extension! Make sure you configure your repositories properly to get the most out of this extension',
          )
        : React.createElement(
            Alert$1,
            { severity: 'error' },
            "The extension hasn't been configured yet. Go to settings for the initial set up.",
          ),
      React.createElement(
        Box$1,
        { p: 1, display: 'flex', justifyContent: 'flex-end' },
        React.createElement(
          Button$1,
          {
        ...
        React.createElement(
          ...
          React.createElement(
            Button$1,
            { href: optionsUrl, target: '_blank', rel: 'noreferrer' },
            'Settings',
          ),
        ),
      ),
  ...
  chrome.storage.sync.get(['db'], (result) => {
    ...
    const App = () =>
      React.createElement(
        React.Fragment,
        null,
        React.createElement(CssBaseline$1, null),
