(function () {
  ...
  function findRepoConfig() {
    ...
    return find$1(configs, (config) => pathname.startsWith(`/${config.repo}/`));
  }
    ...
    for (const entry of newEntries) {
      ...
      try {
        ...
        if (config.autogenerated && !handled) {
          const generatedFile = !!((_a = entry.headerElement.textContent) ===
            null || _a === void 0
            ? void 0
            : _a.match('Some generated files are not rendered by default'));
          if (generatedFile) {
            markAsViewed(entry);
          }
        }
  ...
  function markAsViewed(entry) {
    var _a, _b;
    if (!entry.viewedButton) return;
    const isViewed = entry.viewedButton.getAttribute('aria-pressed') === 'true';
    const checkbox =
      (_a = entry.viewedButton.parentElement) === null || _a === void 0
        ? void 0
        : _a.querySelector('input[name="viewed"]');
    const alreadyViewed =
      isViewed ||
      ((_b =
        checkbox === null || checkbox === void 0
          ? void 0
          : checkbox.checked) !== null && _b !== void 0
        ? _b
        : false);
    if (!alreadyViewed) {
  ...
  chrome.storage.sync.get(['db'], (result) => {
    const repoList = 'db' in result ? result.db : { repos: [] };
